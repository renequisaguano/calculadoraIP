...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        netmask_one_number.setValue(25);
    ...
    OnValueChangeListener onValueChange = new OnValueChangeListener() {
		...
		public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
			...
			if(ip1.getValue()>1 && ip1.getValue()<=126){
				txtclase.setText("Clase A");
			}
			
			if(ip1.getValue()>127 && ip1.getValue()<=191){
				txtclase.setText("Clase B");
			}
			
			if(ip1.getValue()>191 && ip1.getValue()<=223){
				txtclase.setText("Clase C");
			}
